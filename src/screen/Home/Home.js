                  ...
                  <div className="row gx-5 align-items-center">
                      <div className="col-lg-6">
                          <div className="mb-5 mb-lg-0 text-center text-lg-start">
                              <h1 className="display-1 lh-1 mb-3">Le recyclage à portée de tous.</h1>
                              <p className="lead fw-normal text-muted mb-3">Découvrez facilement si votre emballage est recyclable.</p>
                              <a href="/us"><button type="button" class="btn btn_custon_brown btn-sm">En savoir plus</button></a>
                          </div>
                      </div>
                      <div className="col-lg-6">
